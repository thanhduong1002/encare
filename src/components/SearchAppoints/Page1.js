import { Avatar, Button, HStack, Text, useToast, VStack } from '@chakra-ui/react';
...
const Page1 = (props) => {
  ...
  useEffect(() => {
    axios({
        baseURL: `https://encare-doctor.herokuapp.com/api/doctor/appointment/search?keywords=${props.data}&page=1`,
        method: 'get',
        headers: {
